...
document.addEventListener('DOMContentLoaded', async function () {
  document.getElementById('loginMobile').addEventListener('click', () => {
    showModalLogin();
  });

  document.getElementById('loginDesktop').addEventListener('click', () => {
    showModalLogin();
  });
  ...
  document.getElementById('registerMobile').addEventListener('click', () => {
    showModalRegister();
  });

  document.getElementById('registerDesktop').addEventListener('click', () => {
    showModalRegister();
  });

  document.getElementById('registerSection').addEventListener('click', () => {
    showModalRegister();
  });
  ...
  document.getElementById('deleteUserDesktop').addEventListener('click', () => {
    showModalDeleteUser();
  });

  document.getElementById('deleteUserMobile').addEventListener('click', () => {
    showModalDeleteUser();
  });
});
...
async function showModalRegister() {
  const modal = document.getElementById('modal-register');
  const title = document.getElementById('modal-register-title');
  const content = document.getElementById('modal-register-main');
  const btnClose = document.getElementById('close-register');
  ...
  // Evento para lidar com o clique do checkbox
  checkboxIsClient.addEventListener('change', toggleClientFields);

  // Chama a função inicialmente para garantir o estado correto do formulário
  toggleClientFields();
...
async function showModalLogoff() {
  showModalAlert(
    'Confirm',
    'Confirmar Logout!',
    'Deseja mesmo sair?',
